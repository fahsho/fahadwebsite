          ...
          <div className="md:col-span-7 space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6 border-y border-foreground/10 py-8 font-mono">
              <div className="grid grid-cols-3 items-baseline">
                ...
                <span className="col-span-2 text-sm leading-relaxed">I help founders and executives bridge engineering, operations, and sales to ship faster and close bigger deals.</span>
              </div>
              <div className="grid grid-cols-3 items-baseline">
