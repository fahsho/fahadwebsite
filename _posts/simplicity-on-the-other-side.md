...
Take the iPhone as an example of a complex system tirelessly broken down into a simple user experience. Whether you prefer iOS or Android, the iPhone is super easy to use. Apple took a product as complex as building a smartphone and turned it into a device my mom can use like a pro. Brilliant.
...
Every day, write down top three essential tasks and get them done before the end of the day. Get to my three and everything else I can adapt. I'll block time for my top three but keep a fluid schedule otherwise. Too many tasks and apps were too complicated.
...
However, moving fast does not mean we should be reckless, compromise our privacy and security, build crappy products or add complexity unnecessarily.
...
The following is a snapshot of how I have broken down various aspects of removing complexity to achieve our vision. Maintain a simplistic approach to create more value for customers and stay lean in the process.
...
Complex products are challenging to learn and use. The iPhone wasn't the first smartphone, yet Apple made it simple. Complex products and systems are difficult to maintain and can be hazardous within specific applications such as medical and transportation.
...
Encourage open communication and lean practices. Fewer meetings for more focused, deep work.

Keep meetings to 30 minutes or less. I love 15-minute sessions. 

In Sales, conversations over pitch decks. Decks are boring.
...
In Marketing, take a no-gimmicks approach. Chasing search engine rankings and clicks deviates people from the mission. Instead, focus on only a few things.

In Engineering, debate the best methods for delivering outstanding work and ask questions.   Break down a project into eight-week blocks with deliverables every two weeks.
